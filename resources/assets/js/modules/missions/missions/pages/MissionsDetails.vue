<template>
    <div class="main">
        ...
        <missions-details-component :mission="mission" class="margin-top"/>

        <el-steps v-if="(mission.status !== 'canceled') && (mission.status !== 'finished')" class="margin-top"
                  :active="step" align-center>
        ...
        <planned-mission v-if="mission.status === 'planned'" class="margin-top" style="text-align: right"
                         @submit="submit" :mission="mission"/>
